...
import com.example.quotesfamous.core.utils.toListQuoteEntity
...
@Database(entities = [QuoteEntity::class, ], version = 1) //Reflexión toma la clase y la analisa-> que metodos y propiedades tiene
//Clase abstracta y hereda de RoomDatabase
